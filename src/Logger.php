...
class Logger
{
    ...
    public function __construct($filename,$max_age_h = null,$max_size_kb = null,$keepmax = null)
    {
        ...
        if( $max_age_h < 1 || $max_age_h > 60 * 24 ) throw new \LogicException("Invalid value specified for max age");
    ...
    {
        $args = func_get_args();
        if( count($args) < 1 || count($args) > 3 ) throw new \LogicException("Invalid arguments passed to ".__METHOD__);
